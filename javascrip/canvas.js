...
function perdiste() {
    ...
    tablero.fillText("Game over!!!",220,450)
}
function ganaste() {
    ...
    tablero.fillText("You Win,",220,430)
    tablero.fillText("Congratulations!",200,470)
